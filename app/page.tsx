          ...
          <div className="mt-8 md:mt-0 relative">
            <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white shadow-xl">
              <Image 
                ...
                priority
                onClick={() => setImageOpen(true)} // 允许点击放大图片
              />
              <div className="w-full h-full bg-gray-200 flex items-center justify-center">
                <p className="text-gray-500">public\1.jpg</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="rounded-xl border bg-white p-6 transition-all hover:shadow-xl hover:-translate-y-1 duration-300 flex flex-col h-full">
      ...
      <h3 className="text-xl font-semibold mb-4">
        <Link href={`/blog/${slug}`} className="text-gray-900 hover:text-gray-600 transition-colors">
          {title}
        </Link>
      </h3>
